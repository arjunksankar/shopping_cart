...
<body>
    <div class="container">
        <a href="javascript:void(0)" id="view-basket">View Basket</a>
        @for($i=0;$i<10;$i++)
                    ...
                    <div class="row">
                        <div class="col-md-5 col-sm-12 col-xs-12">
                            <div class="product-image">
                                <img src="images/product.jpeg" class="img-responsive">
                        ...
                        <div class="col-md-7 col-sm-12 col-xs-12">
                            ...
                            <div class="product-info smart-form">
                                <div class="row">
                                    <div class="col-md-12">
                                        @if(!in_array($i+1,$added_items))
                                            <a href="{{ route('add_item_to_basket',$i+1)}}" class="btn btn-danger">Add to cart</a>
                                        @else
                                            <a href="javascript:void(0)" class="btn btn-danger">Added</a>
                                            <a href="{{ route('remove_item_from_basket',$i+1)}}" class="btn btn-danger">Remove</a>
                                        @endif
                                    </div>
